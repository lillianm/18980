...
public class Protocol {
	...
	public final static int REQUEST_GPS = "REQUEST_GPS".hashCode();
	public final static int REQUEST_REGISTERED_SENSOR_DATA = "REQUEST_REGISTERED_SENSOR_DATA".hashCode();
	//public final static int REGISTER_SENSOR = 
